    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentityServer()
                ...
                .AddAspNetIdentity<ApplicationUserDto>()
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, UserManager<ApplicationUserDto> userManager, RoleManager<IdentityRole> roleManager)
        {
